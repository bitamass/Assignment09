...
# Bmassoudi, 2022-Dec-12, Modified the File to add tracks functionality
#------------------------------------------#
...
class DataProcessor:
    ...
    @staticmethod
    def add_track(track_info: tuple, cd: DC.CD):
        ...
        """
        # TO DONE add code as required
        trackPos, trackTit, trackLen = track_info
        trackPos1 = int(trackPos)
        cd.add_track(DC.Track(trackPos1, trackTit, trackLen))
